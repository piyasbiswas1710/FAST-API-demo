...
# to create a home page for welcome message
@app.get("/")
def hello():
    return {'message':'Patient Management System API'}


# to create a about page for the API
@app.get('/about')
def about():
    return {'message': 'A fully functional API to manage your patient records'}

# Retrive part 
# to create a view page to view the data from JSON file
@app.get('/view')
def view():
    data = load_data()
...
# to create a view page to view the data of a specific patient from JSON file
...
# to create a sort page to sort the data from JSON file
@app.get('/sort')
def sort_patients(sort_by: str = Query(..., description='Sort on the basis of height, weight or bmi'), order: str = Query('asc', description='sort in asc or desc order')):

# for validation of the query parameters
...
# for sorting the data based on the query parameters   
    data = load_data()
...
# create part
# to create a create page to add the data into JSON file
@app.post('/create')
